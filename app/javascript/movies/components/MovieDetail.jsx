...
export const Info = ({ title, year, genre, rating, synopsis }) => (
  <div>
    ...
    <div className="rating">
      <img src="https://yts.ag/assets/images/website/logo-imdb.svg"
        alt="IMDb Rating" /> <span>{rating}</span>
    </div>
...
export default connect(
  (state, ownProps) => ({ currentMovie: state.currentMovie, id: ownProps.match.params.id }),
  { getMovie }
)(MovieDetail)